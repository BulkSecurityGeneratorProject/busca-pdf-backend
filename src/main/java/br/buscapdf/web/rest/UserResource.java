...
import br.buscapdf.service.UserService;
import br.buscapdf.service.dto.UserDTO;
import br.buscapdf.web.rest.errors.BadRequestAlertException;
import br.buscapdf.web.rest.errors.EmailAlreadyUsedException;
import br.buscapdf.web.rest.errors.LoginAlreadyUsedException;
    ...
    public ResponseEntity<User> createUser(@Valid @RequestBody ManagedUserVM managedUserVM) throws URISyntaxException {
        ...
        if (managedUserVM.getId() != null) {
            ...
            User newUser = userService.createUser(managedUserVM,
                managedUserVM.getCpf(), managedUserVM.getRg(), managedUserVM.getFunctionalNumber());
